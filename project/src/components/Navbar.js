          ...
          <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              <div className="flex flex-shrink-0 items-center">
                <a href="/"><img className="h-8 w-auto" src="https://i.pinimg.com/736x/6a/dc/e6/6adce6c9aa223d1dd232fd690891ddef.jpg" alt="Your Company" /></a>
              </div>
              <div className="hidden sm:ml-6 sm:block">
                <div id='buttons' className="flex space-x-4  ">
                  ...
                  <Link to="/trans" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">trans</Link>
